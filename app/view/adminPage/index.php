            ...
            <div class="accordion" id="accordionExample">
                <div class="accordion-item">
                  ...
                  <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                    <form class="accordion-body form-control" action="<?=BASEURL?>/multiuser/tambahRak" method="POST">
                        <div class="mb-3 row">
                ...
                <br>
                <form action="<?= BASEURL ?>/multiuser/tambahBarang" method="post">
                  <div class="accordion-item">
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                          ...
                          <div class="mb-3 row">
                            ...
                            <div class="col-sm-7">
                              <input class="form-control input-gambar" type="file" id="inputGambar" name="gambarBarang">
                            </div>
                          </div>
                          <div class="mb-3 row col-md-3 save-button">
                              <button type="submit" class="btn btn-primary">Save</button>
